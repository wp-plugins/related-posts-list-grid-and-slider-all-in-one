<?php ob_start();
//define all variables that needed alot
...
<?php
	...
	if($searches){
		echo '<div id="related_posts_ttc"><h3 class="h3_top_style">'. $aio_related_posts_settings['grid_title'] .'</h3><ul class="hfeed posts-default clearfix">';
